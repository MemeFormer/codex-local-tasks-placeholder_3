...
> |---|---|
> | „Die Suntour NEX mit 63 mm ist geometrisch ein passender Ersatz für die originale Suntour-Gabel" | ⛔ **Falsch.** Die Original-Gabel **dieses** Rads ist eine **RST Vogue TNL** (ca. **50 mm**, Coil/Öl, Vorspannung + Lockout) – **und sie ist noch vorhanden** |
> | „Spenderrad-Steuerkopf war kürzer (ca. 23 mm geschätzt)" | ✅ **von dir gemessen: 20–30 mm.** Spenderrad = **Bergamont Horizon 4.0** (Rahmenprägung `52 T4/T6 Heat Treated 6061 Lite Alloy`) |
> | „Sockel-Bund ist **länger** → Sockel **2–2,5 mm zurückdrehen**" | ⛔ **Richtung falsch.** Die Stifte sind **KÜRZER** → die M6-Armschraube findet **keinen Gewindegriff**. **Zurückdrehen verschlimmert es!** Fix: **längere M8-Cantistifte** |
> | „Hintere Bremse kehrt nicht zurück → die zu kurzen Beläge sind Hauptverdächtige" | ✅ **Erledigt.** Ursache war die **Bremshebel-Klemmung am Lenker** (zu nah/fest → **Pivot des hinteren Bremshebels geklemmt**) |
>
...
### ⚠️ Was die Original-Ausstattung betrifft – Prospekt ≠ dein Rad

Die Serien-Recherche zum Staiger Daytona nennt: **Federgabel Suntour mit 63 mm Federweg**,
**Felgen Mach1 210**, **Vorbau/Sattelstütze/Griffe XLC Comp**, **Shimano Deore V-Brakes**,
**Schwalbe Marathon**. **Aber Vorsicht:** Ausstattungen variierten je nach Baujahr und
Händler – **dein Rad weicht an einer entscheidenden Stelle ab.**

| Original-Daytona-Spec (Recherche) | Dein Fund am Rad | Bewertung |
|---|---|---|
| Felgen **Mach1 210** Alu-Hohlkammer | **Mach1 210**, ETRTO 622×19c (**hinten**) | ✅ **original** |
| **XLC Comp** Vorbau, Sattelstütze, Griffe | **XLC-comp** Sattelstütze + Schnellspanner | ✅ **original** |
| Shimano **Deore V-Brakes** | Bremsarme **hinten** Shimano Deore, Bremshebel **BL-M571** | ✅ **original** |
| Schwalbe **Marathon** | **Schwalbe Marathon Plus** 47-622 hinten | ✅ **original** |
| Shimano Deore, 27 Gänge | Deore LX M570/M580 + Deore M511/M530, 3×9 | ✅ **original** |
| ~~Federgabel Suntour 63 mm~~ | 🔴 **RST Vogue TNL** (ca. **50 mm**, Coil/Öl, Lockout) | ⛔ **Prospekt-Angabe trifft auf dein Rad NICHT zu** |

> 🔴 **Wichtigste Konsequenz – korrigiert:**
> Die schwarze **SR Suntour NEX T63** ist **kein Originalteil dieses Rads**, sondern das
> **Originalteil des Spenderrads (Bergamont Horizon 4.0)**. Die **echte Original-Gabel** ist
> die **RST Vogue TNL** – **sie ist noch vorhanden**, aber defekt
> (Öl ausgetreten, Dichtungen hin, leichter Rost an den Standrohren).
>
> **Geometrie:** RST Vogue ≈ **50 mm** Federweg (axle-to-crown ca. **455–465 mm**) vs. NEX
> **63 mm** (ca. **445–469 mm**) → die Differenz ist **klein**, aber messbar.
>
> **Was am weißen Rad heute wirklich original ist:**

| Baugruppe | Original Staiger ✅ | Vom Bergamont-Spenderrad ⛔ |
|---|---|---|
| Rahmen | ✅ Alu 6061 Double Butted, `AWO7230329` | – |
| **Federgabel** | 🔴 **RST Vogue TNL – ausgebaut, vorhanden, defekt** | ⛔ **Suntour NEX T63 (jetzt verbaut)** |
| **Hinterrad** | ✅ Mach1 210 + Deore FH-M530 + Marathon Plus 47-622 | – |
| **Vorderrad** | – | ⛔ **Shining A-M4 + Nabendynamo DH-3N31 + Active Line K-Guard 42-622** |
| Bremshebel (Lenker) | ✅ **BL-M571**, weiß | – |
| Bremsarme **hinten** | ✅ Shimano Deore, weiß | – |
| Bremsarme **vorne** | 🔴 Shimano Deore – **liegen ausgebaut bereit** (passen nicht auf die NEX-Stifte) | ⛔ **Tektro (jetzt verbaut)** |
| Bremsbeläge | 🔴 original Shimano, ca. **72 mm** – **durchgefahren, entsorgt/aufgehoben?** | ⛔ **Tektro 836, 62–63 mm (jetzt verbaut)** |
| Vorbau / Lenker | 🔴 XLC Comp – **ausgebaut, vorhanden?** | ⛔ **BGM-Vario-Quill + Riser (jetzt verbaut)** |
| Schutzblech vorne / Licht | – | ⛔ **vom Spenderrad** |
| Antrieb / Schaltung | ✅ Deore 3×9 | – |
...
| STAIGER-Steuerkopf ist ✅ **gemessen 20–30 mm länger** | → es bleiben nur noch **ca. 2 mm = 1–2 Gewindegänge** übrig |

> 🎯 **Das ist exakt dein Befund.** Der Schaft wurde für den **kürzeren Steuerkopf des
> Bergamont-Spenderrads** gekürzt, und der STAIGER-Rahmen hat ein längeres Steuerrohr.
> ⚠️ Zusätzlich: Weil das Gewinde nur 55 mm lang ist, war der Vorrat von vornherein knapp.

> ⛔ **Und der lange Bergamont-Vorbau rettet die Höhe, aber nicht den Schaft.**
> Der Vorbau des Spenderrads ist **über dem Steuersatz länger und oben einstellbar** – deshalb
> sitzt der Lenker trotz des längeren Steuerrohrs fast auf gleicher Höhe. **Aber:** Ein langer
> Quill-Vorbau **braucht selbst mehr Gabelschaft**, weil er tiefer ins Rohr reichen muss.
> **Höhen-Kompensation ist keine Schaftlängen-Kompensation.**
> → Details in [`../02-teile/20-steuersatz-gabel-vorbau-lenker.md`](../02-teile/20-steuersatz-gabel-vorbau-lenker.md) **Abschnitt 3b**
...
|---|---|---|---|---|
| **0** ⭐ | 🔴 **RST Vogue TNL zurückbauen** – die **Original-Gabel**, vorhanden, für **dieses** Steuerrohr gebaut | 1–1,5 h | 💰 25–50 € (Dichtungen 14,28 € + Öl + Politur) | ✅✅ **beste Lösung** – löst **Baustelle #1, #5 und #6 auf einmal**. Bedingung: Standrohre bestehen den **Fingernageltest** → [Baustelle #14](../04-diagnose/rst-vogue-tnl-federgabel.md) |
...
| 3 | **NEX-Gewindegabel mit 225 mm Schaft** statt 210 mm | mittel | 💰💰 50–90 € | ⚠️ **+15 mm Schaft** – bei **20–30 mm** Steuerrohr-Differenz **allein nicht genug**, nur in Kombination mit 1 oder 4 |
...
| 6 | Gebrauchte 1⅛″-Gewindegabel mit **langem** Schaft (V-Brake-Sockel, 700C, 100 mm QR) | mittel | 💰💰 25–60 € | ✅ gut, wenn verfügbar. 🔴 **Rechnung: Schaft ≥ Steuerrohrlänge + 30 mm + Vorbau-Einstecktiefe** |
| 7 | 🟢 **Riser-Lenker** mit mehr Rise + Staiger-Originalvorbau | gering | 💰 20–40 € | ✅ billigste **Höhen**-Lösung – löst aber **nicht** das Gewinde- und Sockel-Problem |
...
|---|---|---|---|
| **vorne** | ✅ **Shimano Deore LX BL-M571** (weiß, original) | ⚠️ **Tektro** (**Bergamont**-Spenderrad, an der Suntour-NEX-Gabel) | ⚠️ **Tektro 836**, **62 mm**, „EN-STANDARD **B61**" (li + re) |
| **hinten** | ✅ **Shimano Deore LX BL-M571** (weiß, original) | ✅ **Shimano Deore** (weiß, original) | ⚠️ **Tektro 836**, **62 mm** – li. „**B1**", re. „**B44**" |

> ✅ **Baustelle #3 (hintere Bremse kehrt nicht zurück) ist ERLEDIGT.**
> Die Ursache stand **am Lenker**: die **Bremshebel-Klemmschellen** waren **zu nah beieinander
> bzw. zusammen zu fest** angezogen → der **Angelpunkt (Pivot) des hinteren Bremshebels** war
> geklemmt → der Hebel schnappte nicht zurück.
> 🔴 **Merksatz: Erst am Lenker suchen, dann an der Zange.** Anzugsmoment Alu-Lenker: **4–6 Nm**.

### 🟡 Befund 1: Die Beläge sind kürzer als die Originalbeläge – **aber kein Sicherheitsproblem**

| Größe | Wert |
|---|---|
| Verbaute Beläge | **Tektro 836** – Nennlänge **63 mm** (deine Messung 62 mm ✅ bestätigt) |
| 🔴 **Deine Originalbeläge** | ✅ **Shimano, ca. 72 mm** – und **komplett durchgefahren** („mehr als nur abgefahren, die waren durch") |
| Shimano-Serie | **M70T4 = 72 mm**, S65T/M65T = 70 mm → **M70T4 ist exakt deine Original-Länge** |
| Differenz | 🟡 **ca. 9–10 mm kürzer** |

**Konsequenzen – neu bewertet:**

| Effekt | Bewertung |
|---|---|
| ~~Bremse kehrt nicht zurück~~ | ❌ **falsch** – Ursache war die Bremshebel-Klemmung, **erledigt** |
| Weniger Auflagefläche → weniger Bremsleistung | 🟡 spürbar, ca. **12–14 %** – **funktionstüchtig** |
| Belag deckt die Bremsspur nicht vollständig ab | 🟡 die Felge nutzt ungleichmäßig ab |
| Tektro-Beläge haben **eigenes Befestigungsmaterial** | 🟡 funktioniert offensichtlich – bei der nächsten Demontage auf **korrekte Reihenfolge** achten |
| 🔴 **Nebenbefund** | Durchgefahrene Originalbeläge → **Felgenflanke prüfen (Baustelle #2, sicherheitsrelevant!)** |

💰 **Empfehlung:** Beim nächsten Belagwechsel hinten auf **Shimano M70T4 = 72 mm** wechseln
(ca. 8–15 €/Paar, **inkl. korrektem Shimano-Scheibensatz**) – **exakt** die Original-Länge.
🟡 **Qualitätsthema, keine offene Sicherheitsbaustelle** → **Baustelle #3a**.

### ✅ Befund 2: Belag-Codes B1 / B44 – aufgeklärt

Hinten: links **B1**, rechts **B44**. Vorne: beide **B61**.
✅ **Ergebnis deiner Nachschau:** Das sind **sehr kleine, schwer lesbare Prägungen**, und
**alle vier Beläge sehen absolut identisch aus** → **keine unterschiedlichen Mischungen**,
**kein** einseitiges Bremsverhalten. Vermutlich **Chargen-/Produktionsnummern**.
🟢 **Abgehakt.**

### 🔴 Befund 3: Warum die weißen Shimano-Bremsarme nicht auf die NEX-Gabel passten – **KORRIGIERT**

Die Suntour NEX hat **Aluminium-Gabelscheiden** (die **RST Vogue TNL ebenfalls**). Bei
Alu-Gabeln ist der V-Brake-Sockel (Bremsboss) in der Regel ein **eingeschraubter Stahlbolzen**
mit **zwei Abflachungen** für einen Gabelschlüssel – nicht angeschweißt.
✅ **Also tauschbar – dein eigener Plan („die Stahlstifte selbst tauschen") ist richtig.**

> ⛔ **Zurückgezogene Diagnose:** „Der **Bund** des Sockels ist **länger** als die Ausnehmung
> im Bremsarm (5,6 mm vs. 4,3 mm) → Sockel **2–2,5 mm zurückdrehen**."
> **Diese Richtung ist falsch.** Die Stifte der Bergamont-Gabel sind **KÜRZER** als die der
> Staiger-Originalgabel. **Zurückdrehen würde das Problem verschlimmern.**

**Die korrigierte Diagnose:**

| Maß | Befund |
|---|---|
| Stift-Ø gemessen | ✅ **7,95 mm = M8** → **M8-Cantistifte** (nicht M10!) |
| Stiftlänge NEX vs. RST | 🔴 **NEX kürzer** |
| Folge | Die **M6-Befestigungsschraube** des Shimano-Bremsarms findet **keinen ausreichenden Gewindegriff** im Innengewinde des Stifts → Arm hat Spiel / lässt sich nicht festziehen |
| Gabelmaterial | ✅ **beide Alu** → Stifte **eingeschraubt (M8)** → **tauschbar** ✅ |

**Der Fix – drei Wege:**

| Weg | Detail | 💰 |
|---|---|---|
| **A** 🔴 empfohlen | **Längere M8-Cantistifte** einschrauben – **brake-stuff.de CS-M8-VA**, **14,90 €/Paar** (M8, Ø8, **M6-Innengewinde**, **Einschraublänge 10 mm**, **5–6 Nm**, **listet ausdrücklich Staiger**). Alternative **CS-M8-RST** 16 € (verlängertes Gewinde + Zusatzflansch – für RST-Gabeln) | 15–16 € |
| **B** | **Kürzere M6-Armschraube**, falls der Stift genug Innengewinde hat | 1–3 € |
| **C** | **Cantistifte der RST Vogue TNL übernehmen** – wenn die Gabel verschrottet wird | 0 € |
| **D** ⭐ | 🔴 **RST Vogue TNL zurückbauen** – dann passen die weißen Arme **ohne jede Änderung** | 25–50 € |

**Montage neuer Cantistifte (Alu-Tauchrohr!):**

| Schritt | Detail |
|---|---|
| 1. Messen | **Gesamtlänge** + **Einschraublänge** + **Stift-Überstand** der Ist-Stifte → mit dem Datenblatt-PDF von brake-stuff.de vergleichen |
| 2. Markieren | Position des **Federstift-Lochs** fotografieren |
| 3. Lösen | Gabelschlüssel an den Abflachungen, **herausdrehen** (Rechtsgewinde) |
| 4. Reinigen | Gewinde im Tauchrohr **entfetten** (Bremsenreiniger) |
| 5. Einsetzen | **Loctite 243**, **5–6 Nm** (Alu-Gewinde!), Federstift-Loch auf dieselbe Position |
| 6. Warten | **2–3 h** Aushärtzeit vor der ersten Bremsung |
| ⚠️ Grenze | Mindestens **10 mm Einschraublänge** im Tauchrohr – **nicht** zu lange Stifte, die innen am Federstift-Loch anstoßen |

→ Details: [`../04-diagnose/vordere-bremsarme-sockel.md`](../04-diagnose/vordere-bremsarme-sockel.md)
und [`../04-diagnose/rst-vogue-tnl-federgabel.md`](../04-diagnose/rst-vogue-tnl-federgabel.md)
...
| ☐ | 🔴 **Stift-Überstand** + **Gesamtlänge** der Cantistifte – **NEX vs. RST Vogue vergleichen** |
| ☐ | 🔴 **Innengewinde im Stift**: M6, wie viele mm greifbar? |
| ☐ | 🔴 **Bremshebel-Klemmschellen**: Abstand zueinander, Anzugsmoment (4–6 Nm) |
...
### 6.1 Vorderrad – ⛔ **komplett vom Bergamont-Spenderrad**

> 🔴 **Herkunft geklärt:** Das gesamte Vorderrad (Felge + Nabendynamo + Reifen) stammt vom
> **Bergamont Horizon 4.0**, zusammen mit Schutzblech, Licht und den Tektro-Bremsarmen.
> Das **Hinterrad** ist dagegen **original Staiger**.
...
| Zustand | ✅ **ERLEDIGT (Baustelle #13):** Rad läuft frei hängend **mehrere Umdrehungen** nach = **Sollbereich** für ein Nabendynamo-Rad. 🟢 Nur noch **Beobachtung** |
...
| Zustand | ✅ **läuft normal** – *„hat sich wohl eingespielt"* (Baustelle #4 erledigt) · 🟡 **eine kleine Feder** beim Achsausbau verloren → identifizieren (Baustelle #4a) · 🔴 **Bremsflanke prüfen** (die Originalbeläge waren **durchgefahren**) |
...
beide im passenden Bereich.

✅ **Geklärte Herkunft:**

| Reifen | Herkunft | Beleg |
|---|---|---|
| **Schwalbe Active Line K-Guard 42-622** vorne | ⛔ **vom Bergamont-Spenderrad** | Bergamont Horizon 4.0 Serie: **Schwalbe Road Cruiser Kevlarguard 42-622** – kam **mit dem kompletten Spenderrad-Vorderrad** ans weiße Rad |
| **Schwalbe Marathon Plus 47-622** hinten | ✅ **original weißes Rad** | Staiger-Daytona-Serie: **Schwalbe Marathon** |

**Befund B – ✅ Nabendynamo-Lager: ERLEDIGT (Baustelle #13)**
...
> nach wenigen Umdrehungen."*
>
> **Mehrere Umdrehungen sind für ein Nabendynamo-Rad der Sollbereich.** Ein Nabendynamo-Rad
> läuft nie so lange wie ein normales Nabenlager (das Magnet-Rasten bremst immer), aber es darf
> **nicht** nach 1–2 Umdrehungen stehen. 🟢 **Restaufgabe: nur Beobachtung.**

Erfahrungswert aus der Schrauber-Praxis zu Shimano-Nabendynamos (Referenz, falls es wiederkommt):
...
✅ **Abgehakt.** „Vorderrad schwergängig" war **zu feste Lagervorspannung** (nicht Verschleiß)
und ist jetzt eingestellt. Die Methode oben bleibt als **Referenz**.
...
| Feld | Wert |
|---|---|
| **Gabel (jetzt verbaut)** | ⛔ **SR Suntour NEX** – Codes: **KB1E0817**, **SF14 NEX P**, **700C TS T63** – **Originalteil des Bergamont-Spenderrads, NICHT des weißen Rads** |
...
| Gabelscheiden | ✅ **Aluminium** → Bremssockel **eingeschraubt (M8)**, tauschbar |
| Standrohre | Stahl, Ø 28 mm |
| 🔴 **Gabel (Original weißes Rad)** | ✅ **RST Vogue TNL** – **noch vorhanden, aber defekt**. **Coil/Öl**: Öldämpfung rechts, Stahlfeder + MCU links, **hydraulischer Lockout**, Vorspannung einstellbar. Schaft **CroMo 28,6 mm (1⅛″)** oder 25,4 mm (1″). Standrohre **25,4 mm Stahl, Ti-Farbe**, Tauchrohre **Alu**. Federweg ca. **50 mm**, axle-to-crown ca. **455–465 mm** |
| 🔴 **Defekt der RST** | Staubschabring/Spiralfeder ausgefallen → **Öl aus dem Dämpfungsbein** → nur die Feder arbeitet. **Leichter Rost** an den Standrohren |
| 🔴 **Rettungsplan** | [`../04-diagnose/rst-vogue-tnl-federgabel.md`](../04-diagnose/rst-vogue-tnl-federgabel.md) – **Baustelle #14**. **RST Dust Seal Kit Paar 14,28 €** (bike24) + Gabelöl 5W–10W + Chrompolitur → **25–50 €**. ⛔ **Erst Standrohr-Ø messen!** · RST-Vertrieb DE: **Paul Lange & Co.** |
...
### 💡 Zum „ungewohnten Lenker-Gefühl" – Begründung korrigiert

⛔ **Die alte Entwarnung gilt nicht.** Sie lautete „die NEX T63 hat wie die originale
Daytona-Gabel 63 mm Federweg" – aber **deine** Original-Gabel ist eine **RST Vogue TNL mit
ca. 50 mm**, keine Suntour. Die NEX ist damit ca. **0–20 mm höher** in der Einbauhöhe
(axle-to-crown 445–469 mm vs. RST ca. 455–465 mm) → **praktisch kaum spürbar**, aber messbar.

**Wahrscheinlichere Ursachen:**

| Ursache | Gegenmaßnahme |
|---|---|
| 🔴 **Breiterer + stärker gekröpfter Bergamont-Riser** (Serie: **30–33° Backsweep**) – Original war ein **XLC Comp Alu Flatbar** = gerade, schmal | Lenker kürzen (max. 20–30 mm pro Seite, symmetrisch), oder den originalen Flatbar-Typ zurück |
| 🔴 **Anderer Vorbau** (Bergamont BGM-Vario, länger über dem Steuersatz) – Original **XLC Comp** | winkelverstellbaren Vorbau anders einstellen |
...
| Federgabel schwergängig/trocken (20 Jahre alt) | Standrohre reinigen + dünn ölen, auf Spiel prüfen → **Baustelle #14** |
...
| 7 | ✅ Magnet-Test Gabelscheiden: **beide Alu** (NEX + RST Vogue), Bremssockel **eingeschraubt M8** | ✅ |
| 7a | 🔴 **Stift-Überstand + Gesamtlänge** der Cantistifte – **NEX vs. RST vergleichen** | ____ / ____ mm |
| 7b | 🔴 **Innengewinde im Stift** (M6?) – wie viele mm greifbar? | ____ mm |
| 8 | Abstand Mitte Ausfallende → Mitte Bremssockel (Gabel / Hinterbau) | ____ / ____ mm |
| 9 | ⛔ ~~Länge Sockel-Bund vs. Ausnehmung~~ – **falsche Richtung**, ersetzt durch 7a/7b | ✅ |
| 9a | 🔴 **RST Vogue TNL**: **Standrohr-Ø** (25,4 oder 28,6 mm?) → bestimmt den Dichtungssatz | ____ mm |
| 9b | 🔴 **RST Vogue TNL**: **Fingernageltest** an den Standrohren – Grübchen? | ja/nein |
| 9c | 🔴 **RST Vogue TNL**: **Schaftlänge** (Krone → Schaftspitze) + **Gewindelänge** | ____ / ____ mm |
| 9d | 🔴 **Steuerrohrlänge STAIGER** und **Bergamont** (Soll Δ 20–30 mm) | ____ / ____ mm |
| 9e | 🔴 **Bremshebel-Klemmschellen**: Abstand zueinander + Anzugsmoment | ____ mm / ____ Nm |
...
| 17 | Achse bis Gabelkrone an der **NEX** und an der **RST Vogue** (unbelastet) | ____ / ____ mm |
...
| ☐ | **Bremsbeläge hinten** | 🟡 **Shimano M70T4 = 72 mm** (exakt die Länge deiner Originalbeläge) mit Konvex-/Konkavsatz – beim nächsten Belagwechsel | 🟡 | 8–15 € |
| ☐ | **Bremsbeläge vorne** | dito 72 mm (für die Tektro-Zange, falls die 63er ersetzt werden sollen) | 🟡 | 8–15 € |
| ☐ | 🔴 **M8-Cantistifte** | **brake-stuff.de CS-M8-VA**, 14,90 €/Paar (M8, Ø8, **M6-Innengewinde**, Einschraublänge 10 mm, 5–6 Nm, **listet Staiger**) · Alternative **CS-M8-RST** 16 € · 🔴 **Gesamtlänge im Datenblatt-PDF vergleichen** | 🔴 | 15–16 € |
| ☐ | 🔴 **RST Dust Seal Kit** | **Paar, 14,28 €** (bike24) – ⛔ **erst Standrohr-Ø messen** (25,4 vs. 28,6 mm!). Alternative: **Paul Lange & Co.** (RST-Vertrieb DE) | 🔴 | 14,28 € |
...
| ☐ | **SR Suntour NEX Threaded, Schaft 225 mm** | 700C, 63 mm, 1⅛ Zoll Gewinde, V-Brake-Sockel – ⚠️ **nur Plan B**, falls die RST unrettbar ist (+15 mm reicht bei 20–30 mm Δ allein nicht) | 🟡 | 50–90 € |
| ☐ | **Oder: Ahead-Umbau** | NEX gewindelos (Schaft 255 mm) + Ahead-Steuersatz 1⅛ (**EC34/28,6 – EC34/30**, Schalen bleiben im Rahmen!) + Ahead-Vorbau 28,6/25,4 | 🟡 | 70–130 € |
| ☐ | 🔴 **Federankerplatte** | brake-stuff.de, 7,50 € – falls die Federraste der neuen Stifte nicht passt | 🟢 | 7,50 € |
...
- [`../04-diagnose/rst-vogue-tnl-federgabel.md`](../04-diagnose/rst-vogue-tnl-federgabel.md) – 🔴 **Baustelle #14: Original-Gabel retten**
- [`../04-diagnose/vordere-bremsarme-sockel.md`](../04-diagnose/vordere-bremsarme-sockel.md) – Bremssockel-Stifte zu **kurz**
- [`../04-diagnose/hintere-bremse-kehrt-nicht-zurueck.md`](../04-diagnose/hintere-bremse-kehrt-nicht-zurueck.md) – ✅ erledigt (Bremshebel-Klemmung)
- [`../04-diagnose/vorderrad-schwergaengig.md`](../04-diagnose/vorderrad-schwergaengig.md) – ✅ erledigt (Nabendynamo-Lager)
- [`../01-bikes/schwarzes-spenderrad.md`](schwarzes-spenderrad.md) – **Bergamont Horizon 4.0**

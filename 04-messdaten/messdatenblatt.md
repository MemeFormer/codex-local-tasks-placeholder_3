...
**Zweck:** Einmal am Rad alles ablesen/einmessen, was man später zum Bestellen braucht.
Dann nie wieder raten.

**Benutzung:** Diese Datei ausdrucken oder aufs Handy laden, ans Rad gehen, ausfüllen,
danach die Werte in die jeweilige `02-teile/`-Datei übertragen.

**Benötigt:** Messschieber (wichtig!), Zollstock, Taschenlampe, Kamera, Notizblock.
**Dauer:** 🎯 **nur noch ca. 25–35 min** – die meisten Teilenummern sind schon bekannt!
...
| 🔴 | **Quill-Vorbau: MIN-INSERTION-Markierung – liegt sie IM Schaftrohr?** 🔴 SICHERHEIT | | |
| 🔴 | **Quill-Vorbau: Einsteck-Ø** (muss **25,4 mm** sein!) | | ❓ ____ mm |
| ☐ | Quill-Vorbau: Länge des Einsteckteils | | ❓ ____ mm |
| ☐ | Quill-Vorbau: Keilschraube (Inbus-Größe) | | |

## 2. Vorbau & Lenker (10 min)

| ☐ | Messung | Wert |
|---|---|---|
| ☑ | Vorbau-Typ (Quill / Ahead) | ✅ **Quill** (Schaftvorbau mit Innenkeil), vom Spenderrad |
| ☑ | Vorbau winkelverstellbar? Verstellbereich (°) | ✅ **ja**, ❓ Bereich ____° |
| ☐ | Vorbau-Länge (Mitte Schaft → Mitte Lenkerklemmung) | ❓ ____ mm |
| 🔴 | Lenker-Klemm-Ø (→ 25,4 / 26,0 / 31,8) | ❓ ____ mm (entscheidet über den Ahead-Vorbau bei Umbau-Variante D) |
| ☐ | Lenkerbreite (Gesamt) | |
| ☐ | Lenker Rise (Höhe Mitte → Höhe Griffbereich) | |
| ☐ | Lenker Backsweep / Upsweep (°) – falls aufgedruckt | |
| ☐ | Lenker-Material (Magnet) | |
...
|---|---|---|---|
| ☑ | **Nabendynamo?** | ✅ **ja – Shimano DH-3N31-NT, 6 V / 3 W** | – |
| ☑ | Naben-Modellnummer | ✅ **DH-3N31-NT** (Code K911) | ✅ **FH-M530 (VIAM)** |
| ☑ | Lagertyp (Konus / Industrielager) | ✅ **Konuslager** | ✅ **Konuslager** |
| 🔴 | **Einstellseite** | ⚠️ **nur LINKS** (ohne Kabelanschluss!) | ⚠️ **nur LINKS** (ohne Kassette!) |
| ☐ | Konusschlüssel-Größe (mm) | ❓ ____ | ❓ ____ |
...
| ☑ | Reifen: zulässiger Druck | ❓ ablesen | ✅ **3,0–5,0 bar** |
| ☐ | Ventil-Typ (Sclaverand / Schrader / Dunlop) | | |
| ☐ | Seitenschlag (mm) | | |
| ☑ | Einbaubreite (Ausfallende innen, mm) | ✅ **100 mm** | ❓ vermutlich **135 mm** – messen |
| ☑ | Kassette / Freilauf | – | ✅ **9-fach HG-Spline**, ❓ Modell + Abstufung (max. **34 Zähne** wg. RD-M511) |

## 4. Antrieb (15 min)

| ☐ | Messung | Wert |
|---|---|---|
| ☑ | Kurbel-Modellnummer (Innenseite des Arms) | ✅ **Shimano Deore FC-M530/531** |
| 🔴 | **Zähnezahl Kettenblätter (3×)** – 48-36-26 (Trekking) oder 44-32-22 (MTB)? | ___ / ___ / ___ |
| ☑ | Kurbelarmlänge (mm) | ✅ **170 mm** |
| ☑ | Innenlager-Typ (Vierkant / Octalink / Hollowtech) | ✅ **Octalink** (Hollowtech-Kurbelarme, **kein** Hollowtech-II-Außenlager!) → gehört **BB-ES25** |
| ☐ | Innenlager-Gehäusebreite (✅ vermutlich **68 mm** BSA) + 🔴 **Achslänge** (113/118/121/126 mm) | |
| 🔴 | **Kassetten-Modellnummer + Abstufung** (Deore-Ära: CS-HG50-9 **11-32**) | |
| 🔴 | Größtes Ritzel (Zähne) – **max. 34 wg. RD-M511!** | |
| ☐ | Kleinstes Ritzel (Zähne) | |
| ☑ | Kassette oder Schraubkranz? | ✅ **Kassette** (HG-Spline auf FH-M530) |
| ☑ | **Ketten-Modellnummer – NEUKAUF-SPEC** | ✅ **Shimano CN-HG53** (9-fach, Original-Spec FC-M530) · ❓ Aufdruck der **aktuellen** Kette |
| ☐ | Ketten-Gliederzahl (der **aktuellen**, zu kurzen Kette) | ❓ ____ |
| ☐ | Kettenverschleiß (Lehre, %) | |
| ☐ | Kettenschloss-Typ (Shimano-Nietstift / KMC / SRAM) | |
| 🔴 | **Kettenstrebenlänge** (Mitte Tretlager → Mitte Achse) – für die Kettenlängenrechnung | ❓ ____ mm (Daytona ca. 445–450 mm) |
| ☑ | Schaltwerk-Modellnummer + Käfiglänge | ✅ **RD-M511**, 9-fach, ❓ **SGS-Langkäfig** bestätigen |
| ☑ | Umwerfer-Modellnummer + 🔴 **Schellen-Ø** (28,6 oder 31,8 mm) | ✅ **FD-C050** („OP Swing" = Top Swing) · Schellen-Ø ❓ ____ mm |
| ☑ | Schalthebel-Modellnummer + Typ | ✅ **SL-M580**, **Trigger (Rapidfire)**, 9-fach, Klemmung 22,2 mm |
| ☐ | Umwerfer: Zugansteuerung **Top Pull** oder **Bottom Pull**? | |
| ☐ | Schaltauge gerade? (Sicht von hinten) | |
| ☑ | Pedal-Gewinde | ✅ **9/16″ × 20 tpi** · ❓ Pedal-**Modell** noch unbekannt |
| 🔴 | Big-Big-Test: Käfig gestreckt? Abstand Leitrolle → Ritzel (mm) – Soll ≥ 5 mm | |
| ☐ | Kettenlinie (Mitte Kettenblatt → Mitte Tretlagergehäuse) · Soll **47,5 / 50 mm** | ❓ ____ mm |
...
| ☐ | Messung | Vorne | Hinten |
|---|---|---|---|
| ☑ | **Bremsentyp** | ✅ **V-Brake** (long pull) | ✅ **V-Brake** (long pull) |
| ☑ | **Bremshebel (Lenker)** | ✅ **Shimano BL-M571**, weiß, original | ✅ **Shimano BL-M571**, weiß, original |
| ☑ | **Bremsarme (Zange)** | ⚠️ **Tektro**, schwarz (Spenderrad) | ✅ **Shimano Deore**, weiß, original |
| ☑ | **Bremsbeläge** | ❓ welche? | 🔴 **Tektro 836**, li **B1** / re **B44**, **62 mm** |
...
| ☐ | Messung | Wert |
|---|---|---|
| ☑ | Nabendynamo-Modellnummer | ✅ **Shimano DH-3N31-NT**, **6 V / 3 W**, Kabel **400–716 mm**, Code **K911** |
| 🔴 | Nabendynamo-Lagervorspannung: Spiel **ohne** QR? Spiel **mit** gespanntem QR? (🔴 **nur links einstellen!**) | |
| ☐ | Scheinwerfer-Modellnummer + Standlicht | |
| ☐ | Rücklicht-Modellnummer + Standlicht | |
| ☐ | Anzahl Adern (1 + Rahmenmasse oder 2) | |
| ☐ | Kabelquerschnitt (mm²) | |
| ☐ | Alle Lötstellen mit Schrumpfschlauch geschützt? | |
| ☐ | Scheuerstellen an der Kabelführung? | |
| ☐ | Spannung bei mittlerer Drehzahl (V AC) | |

## 7. Anbauteile (10 min)

| ☐ | Messung | Wert |
|---|---|---|
| ☐ | Schutzblechbreite v/h | ___ / ___ |
| ☐ | Abstand Reifen → Schutzblech engste Stelle v/h | ___ / ___ |
| ☐ | Schutzblech-Montagepunkte v (Gewinde M5 in der Gabelbrücke?) | |
| ☐ | Schutzblech-Montagepunkte h | |
| ☐ | Auslösekupplung vorne vorhanden? | |
| ☐ | Ständer: Modell / Aufdruck | |
| ☐ | Ständer: Aufnahme-Typ (KSA 40 / KSA 18 / Kettenstreben-Platte) | |
| ☐ | Ständer: Lochabstand der Aufnahme (mm) | |
| ☐ | Ständer: Schrauben (M___ × ___) | |
...
## 📸 Foto-Checkliste (parallel zum Messen)

| ☐ | Foto | Zweck |
|---|---|---|
| ☐ | Beide Räder komplett, jeweils von rechts und links | Übersicht |
| ☐ | Rahmennummer (unter Tretlagergehäuse) | Identifikation |
| ☐ | Steuerkopf mit Mutter/Konus (Nahaufnahme, seitlich beleuchtet) | Gewinde-Problem dokumentieren |
...
| ☐ | Vorderrad-Nabe, beide Seiten (vor dem Öffnen) | Lager-Reihenfolge |
...
| ☐ | Nabendynamo-Anschluss | Elektrik |
| ☐ | Alle Lötstellen | Elektrik-Doku |

**Foto-Ablage:** lokal unter `fotos/YYYY-MM-DD/` (nicht im Repo, siehe `.gitignore`).
Hier nur den Pfad notieren:

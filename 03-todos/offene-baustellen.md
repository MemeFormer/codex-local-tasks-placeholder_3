...
|---|---|---|---|---|---|
| **14** | 🆕 **RST Vogue TNL retten?** (Original-Gabel, noch vorhanden) | 🔴 | 🔴 **PLANWECHSEL: „Plan A-Head"** statt „Plan A+ mit Quill" – die Rettung der Gabel bleibt, aber sie wird **auf A-Head zurückgerüstet** | 🔴🔴 **ERST Prüfungen 0a + 0c + 0d.** Besitzer 2026-09-05: der Originalvorbau war **„fast sicher ein A-Head-Vorbau"** und ist **noch vorhanden**. **EC34 kann beides** – Gewinde *und* A-Head, dasselbe 33,9-mm-Steuerrohr. → **Rückrüstung auf den Originalzustand**, und **#1/#5/#6 werden gegenstandslos.** 🔴 **Fotos stehen aus.** Dann Fingernageltest + Standrohr-Ø + Schaftlänge | [`../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md`](../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md) · [`../04-diagnose/rst-vogue-tnl-federgabel.md`](../04-diagnose/rst-vogue-tnl-federgabel.md) Abs. 3.0 |
| **15** | 🟢 **Schaltauge prüfen** – Folge eines Sturzes vor Jahren | 🟢 **niedrig** | ✅ **geklärt und herabgestuft** (2026-09-05) | 🟢 **Nur noch Sichtprüfung** (von hinten: Schaltwerkskäfig **parallel** zu den Ritzeln). **Keine Richtlehre.** 🔴 **Ein krummes Schaltauge richtet sich nicht von selbst** – jahrelang einwandfreies Schalten spricht dagegen. Der Schlag traf **das Schaltwerk selbst**; Dirk hat es **gangbar gemacht und frisch eingestellt**, danach **„alles einwandfrei" – bis heute** | ❓ **Offen bleibt:** warum wurde *vorne* ein Umwerfer getauscht, wenn der Schaden *hinten* war? → [`fragen-an-dirk.md`](fragen-an-dirk.md) **Frage 4** · [`../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md`](../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md) Abs. 4 |
...
|---|---|---|
| **1** | Quill-Vorbau erreicht die Mindesteinstecktiefe evtl. nicht | NEX-Schaft ist für ein **20–30 mm kürzeres** Steuerrohr gekürzt; der lange Bergamont-Vorbau **braucht mehr** Schaft, nicht weniger · 🟢 **Wird bei Plan A-Head GEGENSTANDSLOS** – dann gibt es **keinen Quill-Vorbau mehr** (→ [`../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md`](../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md)) |
| **5** | Die guten weißen **Deore**-Bremsarme lassen sich nicht sicher befestigen | Die **Cantistifte der Bergamont-Gabel sind kürzer** → die M6-Armschraube findet **keinen Gewindegriff** im Stift · 🟢 **Wird bei Plan A-Head wahrscheinlich gegenstandslos** – die **originalen Deore-Arme** kommen an die **originalen RST-Cantistifte**. 🔴 **Vorher messen** |
| **6** | Zu wenig Gewinde für die Kontermutter | NEX-Gewindeschäfte haben ab Werk nur **ca. 55 mm Gewinde oben**; gekürzt für das **kürzere Bergamont-Steuerrohr** → STAIGER-Steuerrohr ist **20–30 mm länger** · 🟢 **Wird bei Plan A-Head GEGENSTANDSLOS** – dann gibt es **kein Gewinde mehr**, die Vorspannung übernimmt die **Ahead-Kappe** |
...
| 🔴 **Warum Schritt 0 nötig ist** | Der **Staiger-Katalog 2007** nennt für Daytona **und** Idaho: *„Federgabel RST Vogue TNL, lockout **mit Aluschaft**"* + *„Steuersatz VP A45AC **A-Head semi-integriert** 1⅛ Zoll"* + *„Vorbau XLC Comp Alu **A-Head**"*. **Dieses Rad hat aber Gewindesteuersatz + Quill-Vorbau.** 🟢 **Geklärt (2026-09-05): *kein* anderes Baujahr** – die Nachrecherche über **vier Modelljahre (2007/2008/2012/2016)** zeigt **alle A-Head**. Die Erklärung ist **EC34 kann beides**: Gewinde- **und** A-Head-Steuersatz teilen sich dasselbe **33,9-mm-Steuerrohr** ⇒ **Rückrüstung möglich = Plan A-Head**. 🔴 **Prüfung 0d** (stehen die Lagerschalen außen vor?) bestätigt EC34 in zwei Sekunden. |
...
| 🔴 **PLANWECHSEL 2026-09-05: „Plan A-Head"** | Der Besitzer antwortet auf Prüfung **0c**: der Originalvorbau war **„fast sicher ein A-Head-Vorbau"** – und **er ist noch vorhanden** (*„ALLES"*). 🔴 **Damit kippt Plan A+ (RST mit Quill-Vorbau zurückbauen):** eine Ahead-Gabel mit **Aluschaft** darf **nie** einen Quill-Keil spreizen. 🟢 **Der bessere Weg ist die Rückrüstung auf A-Head:** **EC34 kann beides** – Gewinde- und A-Head-Steuersatz teilen sich **dasselbe 33,9-mm-Steuerrohr**. Der heutige Gewinde-Zustand ist eine **Umrüstung** und ist **umkehrbar**. **Vorteile:** ✅ Originalzustand · ✅ **Aluschaft-Risiko entfällt** (A-Head klemmt außen) · 🟢 **#1, #5 und #6 werden gegenstandslos** · ✅ Vorbauhöhe frei über Spacer · ✅ **Vorbau kostet 0 €** · 💰 neu nur **EC34-A-Head-Steuersatz 10–25 €**. 🔴 **Offen: Schaftlänge der RST messen + Fotos vom Vorbau.** → [`../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md`](../06-logbuch/2026-09-05-vier-antworten-ahead-wende.md) |

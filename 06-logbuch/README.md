...
| **2026-09-04** | [🎯 Komponenten entschlüsselt](2026-09-04-komponenten-entschluesselt.md) ⚠️ **teilweise korrigiert am 09-05** | **Alle Teilenummern dekodiert** ✅ · 🔴 **#6-Ursache gefunden**: NEX-Schaft hat nur 55 mm Gewinde, wurde gekürzt ✅ (Δ jetzt **gemessen 20–30 mm**) · ⛔ ~~**#5-Ursache**: Sockel-Bund 5,6 mm vs. Deore-Arm 4,3 mm → Sockel 2–2,5 mm zurückdrehen~~ → **korrigiert: Stifte sind KÜRZER, längere M8-Stifte kaufen** · ⛔ ~~**#3 belegt**: Tektro 836 = 63 mm in einer 70-mm-Deore-Zange~~ → **korrigiert: Bremshebel-Klemmung am Lenker** · ⛔ ~~**#13 wieder offen**~~ → ✅ **erledigt** · ⛔ ~~**#9 entwarnt**: original Daytona hatte Suntour 63 mm~~ → **Original-Gabel war die RST Vogue TNL (ca. 50 mm)** | #3 #5 #6 #7 #9 #13 |
| **2026-09-03** | [Rückfrage: drei Diagnosen korrigiert](2026-09-03-rueckfrage-korrekturen.md) | Nabendynamo bestätigt ✅ · V-Brake bestätigt ✅ · STAIGER ✅ · „Bremshebel“ waren **Bremsarme** → Federraste ist die Lösung ✅ · ⛔ ~~hintere Beläge sind Hauptverdacht für #3~~ → **korrigiert am 09-05: Bremshebel-Klemmung** | #3 #5 #6 #13 |
